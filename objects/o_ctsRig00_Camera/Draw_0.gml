...
{
	// give it sky blue
	draw_clear_alpha(make_color_rgb(85, 141, 222), 1.0);
	...
	var mat_projection = matrix_build_projection_perspective_fov(fov_vertical, Screen.width / Screen.height, 1, 4000);
