/// @description "New magical hazard" light

var blender = m_timer;

var draw_x = xoffset + GameCamera.x;
var draw_y = yoffset + GameCamera.y - (GameCamera.height * 0.5) + 80;
...
var t_textAlpha = saturate(blender * 0.5);
var t_shapeAlpha = saturate(blender * 1.0);
// Fade out the effects
t_shapeAlpha *= saturate(1.0 - (blender - 2.0));
t_textAlpha *= saturate(1.0 - (blender - 3.0));
