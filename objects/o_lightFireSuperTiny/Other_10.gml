...
draw_circle_color(x + xoffset, y + yoffset, (70 + ro0) * 0.5, merge_color(c_gold, c_black, 0.4), c_black, false);
draw_circle_color(x + xoffset, y + yoffset, (40 + ro1) * 0.5, merge_color(c_yellow, c_black, 0.25), c_black, false);
draw_circle_color(x + xoffset, y + yoffset, (8 + ro2) * 0.5, c_white, c_ltgray, false);
