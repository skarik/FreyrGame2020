...
menuListing = [
	...
	["Vendor Demo", "Places you next to a vendor with a good amount of items, to t_try out some trading. Head inside the tavern to the left for a second vendor.", true, 5],
