function ctsParseDialogue() {
	...
	{
		input_text = string_replace_all(input_text, "[PLAYER]", o_PlayerStats.m_name);
		input_text = string_replace_all(input_text, "[PLAYER_NICKNAME]", string_copy(o_PlayerStats.m_name, 1, 2));
	}
