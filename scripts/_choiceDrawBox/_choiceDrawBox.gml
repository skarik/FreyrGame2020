function _choiceDrawBox() {
	...
	var boxh_st = _choiceBoxHeight(); //ceil( display_font_height*0.5 + ((display_font_height+3) * input_choice_count));
	...
	/*var tC = make_colour_hsv(color_get_hue(background_colour), 255, 90);
